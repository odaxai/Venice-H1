...
Usage:
  # Use multiple GPUs
  python scripts/extract_grid_features_fast.py --world_auto --gpus 0,1 --batch_size 128

  # Resume
  python scripts/extract_grid_features_fast.py --world_auto --gpus 0,1 --resume

  # Merge
  python scripts/extract_grid_features_fast.py --merge --cache_dir ././outputs/feature_cache
"""
...
def main():
    ...
    parser.add_argument("--batch_size", type=int, default=128, help="128 is typical sweet spot")
