...
Usage:
  # Use both 3090, output to /home/bionick87/miccai_2026/features (default)
  python scripts/extract_grid_features_eccv.py --world_auto --gpus 0,1 --batch_size 128

  # Custom cache dir (always use absolute path so saves work after os.chdir)
  python scripts/extract_grid_features_eccv.py --world_auto --gpus 0,1 --cache_dir /home/bionick87/miccai_2026/features --num_workers 16

  # Resume
  python scripts/extract_grid_features_eccv.py --world_auto --gpus 0,1 --resume

  # Merge
  python scripts/extract_grid_features_eccv.py --merge --cache_dir /home/bionick87/miccai_2026/features
"""
...
def main():
    ...
    parser.add_argument("--cache_dir", default="/home/bionick87/miccai_2026/features",
    ...
    parser.add_argument("--batch_size", type=int, default=64, help="3090: 64 safe (model uses ~5GB, leaving room for activations)")
